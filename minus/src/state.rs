...
pub struct SearchState {
    ...
    /// Stores the previous search term for repeat searches
    pub(crate) previous_search_term: Option<regex::Regex>,
...
impl PagerState {
    ...
    pub(crate) fn append_str(&mut self, text: &str) -> AppendStyle<'_> {
